...
use tiresias::{RandomnessSpaceGroupElement, RandomnessSpaceValue};
...
pub fn encrypt(text: Vec<u8>, public_key: Vec<u8>) -> Vec<u8> {
    ...
    let deser_plaintext: LargeBiPrimeSizedNumber = bincode::deserialize(&text).unwrap();
    const N: LargeBiPrimeSizedNumber = LargeBiPrimeSizedNumber::from_be_hex("");
    let public_parameters = tiresias::encryption_key::PublicParameters::new(N).unwrap();
    ...
    encryption_key.encrypt_with_randomness(_, &randomness, &public_parameters);
    Vec::new()
}
